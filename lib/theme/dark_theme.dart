...
ThemeData dark = ThemeData(
  fontFamily: 'Roboto',
  primaryColor: const Color(0xFFdd3135),
  ...
  colorScheme: const ColorScheme.dark(primary: Color(0xFFdd3135), secondary: Color(0xFFdd3135)).copyWith(error: const Color(0x00000000)),

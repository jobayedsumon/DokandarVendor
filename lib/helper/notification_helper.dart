...
import 'package:dokandar_shop/features/dashboard/widgets/new_request_dialog_widget.dart';
  ...
  static NotificationBody convertNotification(Map<String, dynamic> data) {
    if (data['type'] == 'general') {
      ...
      return NotificationBody(
          ...
          notificationType: NotificationTypeModel.order);
    } else {
      return NotificationBody(
        ...
        conversationId: (data['conversation_id'] != null &&
            ...
            : null,
        notificationType: NotificationTypeModel.message,
        type: data['sender_type'] == AppConstants.deliveryMan

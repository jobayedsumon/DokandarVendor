...
import 'package:dokandar_shop/common/widgets/switch_button_widget.dart';
import 'package:dokandar_shop/features/profile/widgets/profile_bg_widget.dart';
import 'package:dokandar_shop/features/profile/widgets/profile_card_widget.dart';
          ...
          circularImage: Container(
            ...
            child: ClipOval(child: CustomImageWidget(
              image: _isOwner ? '${Get.find<SplashController>().configModel!.baseUrls!.vendorImageUrl}'
                  ...
                  : '${Get.find<SplashController>().configModel!.baseUrls!.vendorImageUrl}/${profileController.profileModel!.image}',

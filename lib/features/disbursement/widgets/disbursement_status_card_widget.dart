...
class DisbursementStatusCardWidget extends StatelessWidget {
  ...
  const DisbursementStatusCardWidget({super.key, required this.amount, this.isPending = false, this.isCompleted = false, this.isCanceled = false, required this.text, this.pendingToolTip, this.completeToolTip, this.canceledToolTip});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: Get.isDarkMode ? null : [BoxShadow(color: Colors.grey[200]!, spreadRadius: 0.5, blurRadius: 0.5)],
      ),

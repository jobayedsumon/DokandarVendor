...
import 'package:dokandar_shop/features/store/widgets/item_view_widget.dart';
import 'package:dokandar_shop/features/store/widgets/review_widget.dart';
    ...
    return GetBuilder<StoreController>(builder: (storeController) {
      return GetBuilder<ProfileController>(builder: (profileController) {
        ...
        return Scaffold(
          ...
          floatingActionButton: storeController.tabIndex == 0 && Get.find<ProfileController>().modulePermission!.item! ? FloatingActionButton(
            heroTag: 'nothing',
            onPressed: () {
              ...
              SliverToBoxAdapter(child: AnimatedBuilder(
                ...
                builder: (context, child) {
                  if (_tabController!.index == 0) {
                    ...
                    return Get.find<ProfileController>().modulePermission!.reviews! ? storeController.storeReviewList != null ? storeController.storeReviewList!.isNotEmpty ? ListView.builder(
